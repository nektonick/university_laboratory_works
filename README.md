...
- ## ООП
  - ### Основные задачи
    ...
    - [Практическая работа 6](ООП/Practical_work_6/Practical_work_6.cpp) [в ожидании проверки]
...
- ## НИР
  ...
  - ### Файлы практических работ
    ...
    - [Практическая работа 5](НИР/homework_5.ipynb) [в ожидании проверки]
    - [Практическая работа 6](НИР/homework_6.ipynb) [в процессе работы]
  - ### Файлы отчётов
